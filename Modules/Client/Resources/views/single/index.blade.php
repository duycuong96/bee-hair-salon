	...
	<h3 class="heading text-center mb-3 mb-sm-5">Thông tin salon</h3>
            <div class="single-w3pvt-page mt-md-5 mt-4 px-lg-5">
                <div class="content-sing-w3ls">
                    <img class="img-fluid" src="{{asset('client/images/ban3.jpg')}}" alt="">
                ...
                <div class="row my-lg-5 mt-3 mx-0">
                    ...
                    <div class="col-lg-6 mt-3 team-img">
                        <div class="row">
                            <div class="col-6">
                                <img src="{{asset('client/images/s1.jpg')}}" class="img-fluid" alt="user-image">
                            </div>
                            <div class="col-6">
                                <img src="{{asset('client/images/s2.jpg')}}" class="img-fluid" alt="user-image">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="comment-sec-w3ls">
                    ...
                    <ul class="list-unstyled">
                        <li class="media">
                            <img class="mr-3 img-fluid" src="{{asset('client/images/sb1.jpg')}}" alt="">
                        ...
                        <li class="media my-5">
                            <img class="mr-3 img-fluid" src="{{asset('client/images/sb2.jpg')}}" alt="">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="mr-3 img-fluid" src="{{asset('client/images/sb3.jpg')}}" alt="">
                            <div class="media-body">
