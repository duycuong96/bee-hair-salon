...
@section('title', 'Thêm thời gian biểu')
...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.thoi-gian-bieu.store') }}" method="POST">
                        @csrf
                        <!-- time Picker -->
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group d-flex justify-content-center">
                            <a href="{{ route('admin.thoi-gian-bieu.index') }}" class="btn btn-lg btn-default mr-3">Trở
                                lại</a>
