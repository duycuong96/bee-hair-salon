    ...
    <div class="sidebar">
       ...
       with font-awesome or any other icon font library -->
                ...
                <li class="nav-item has-treeview {{ request()->routeIs('admin.khach-hang*') ? 'menu-open' : '' }}">
                    <a href="" class="nav-link {{ request()->routeIs('admin.khach-hang*') ? 'active' : '' }}">
                ...
                <li class="nav-item has-treeview {{ request()->routeIs('admin.tai-khoan*') ? 'menu-open' : '' }}">
                    <a href="" class="nav-link {{ request()->routeIs('admin.tai-khoan*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.lien-he.index') }}"
                        class="nav-link {{ request()->routeIs('admin.lien-he*') ? 'active' : '' }}">
                        <i class="nav-icon fab fa-usps"></i>
                        <p>Quản lý liên hệ</p>
                    </a>
                </li>
